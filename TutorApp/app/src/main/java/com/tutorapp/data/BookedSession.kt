...
import com.tutorapp.models.BookedSession as DomainBookedSession
...
interface BookedSessionDao {
    ...
    @Query("SELECT * FROM booked_sessions WHERE dateTime LIKE :datePattern || '%'")
    suspend fun getSessionsForDate(datePattern: String): List<BookedSessionEntity>
